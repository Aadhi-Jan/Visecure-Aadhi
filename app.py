...
def predict():
    appData = str(request.args.get('param1'))
    appData1 = 'Prediction for param1: {param1}'
    # return(jsonify(appData, request.args.get('param1'), 'done'))
    ...
    if url != "":
        ...
        if result==1:
            ...
            try:
                page_rank = search.google_pagerank(url)
            except:
                page_rank = 0
        ...
        if result==1:
            response_data = {
                'prediction' : "The website look's clean"
            }
            return jsonify(response_data), 200
        else:
            response_data = {
                'prediction' : "The website look's suspicious"
            }
